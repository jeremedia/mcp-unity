...
namespace McpUnity.Unity
{
    ...
    public class McpUnityServer
    {
        ...
        private void RegisterTools()
        {
            ...
            // === CURATION ENGINE TOOLS ===
            // Register CurationEngineTestTool
            CurationEngineTestTool curationEngineTestTool = new CurationEngineTestTool();
            _tools.Add(curationEngineTestTool.Name, curationEngineTestTool);
            
            // Register BuilderBrowserAutomationTool
            BuilderBrowserAutomationTool builderBrowserAutomationTool = new BuilderBrowserAutomationTool();
            _tools.Add(builderBrowserAutomationTool.Name, builderBrowserAutomationTool);
        }
